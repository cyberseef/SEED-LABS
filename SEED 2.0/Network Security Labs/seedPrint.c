...
#include <linux/tcp.h>
#include <linux/udp.h>
#include <linux/icmp.h> // Added this header to catch ICMP
                       ...
                       const struct nf_hook_state *state)
{
   ...
   u16  port   = 53;
   char ip[16] = "8.8.8.8"; // Can be replaced by 8.8.4.4 or any other reachable dns server IP if the given is not available
   u32  ip_addr;
